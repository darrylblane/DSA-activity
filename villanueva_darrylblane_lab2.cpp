...
int main()
{
    ...
    traverse(head);
    head = insertAtEnd("Hit em up By 2pac", head);
    traverse(head);
    head = insertAtEnd("It Wasn't Me by Shaggy", head);
    traverse(head);
    head = insertAtEnd("Do For Love by 2pac", head);
    traverse(head);
    head = insertAtBeginning ("Without Me by Eminem", head);
    traverse(head);
    ...
    traverse(head);
    cout << insertAfter("Without Me by Eminem","Ikaw lang by Nobita", head);
    traverse(head);
    cout << insertAfter("Can We Make love by Keith Sweat","Lihim by Arthur Miguel", head);
    traverse(head);
    cout << insertAfter("You are Not Alone by Michael Jackson","uhaw by dilaw", head);
    traverse(head);
